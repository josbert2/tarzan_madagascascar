...
workbook = xlrd.open_workbook("Excel_Madagascar/STFEntreKids_invitacion.xlsx","rb")
...
for i in range(len(type_code)):
    ...
    if type_code[i] == 'Palco':
        ...
        loadQR = loadQR.resize((220, 220), Image.ANTIALIAS)
        ...
        #TEMPLATE_TARZAN.save('QR_STFENTREKIDS_INVITACION/qr_' + str(type_code[i].lower()) + '_' + str(i) + '.png')
