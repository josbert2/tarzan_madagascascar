...
for i in range(len(type_code)):
    ...
    if type_code[i] == 'PLATEA':
        ...
        draw.text( (TEXTO_QR_W - 35, TEXT_QR_H + 235), str(data),  fill="white", font=font)
        

       
        TEMPLATE_TARZAN.save('QR_TARZAN_CORTESIAS/qr_' + str(type_code[i].lower()) + '_' + str(i) + '.png')
